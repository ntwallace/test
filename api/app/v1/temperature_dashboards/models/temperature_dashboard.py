...
class TemperatureDashboard(Base):
    __tablename__ = 'temperature_dashboards'

    temperature_dashboard_id: Mapped[UUID] = mapped_column(primary_key=True, default=lambda: uuid4())
