...
def test_get_hvac_zone_temperature_sensors_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.get(f'/v1/hvac-zone-temperature-sensors?hvac_zone_id={uuid4()}')
...
def test_get_hvac_zone_temperature_sensors_access_scopes(
    ...
    response = test_client.get(f'/v1/hvac-zone-temperature-sensors?hvac_zone_id={hvac_zone.hvac_zone_id}')

    assert response.status_code == response_code


def test_get_hvac_zone_temperature_sensors_success_response(
...
def test_get_hvac_zone_temperature_sensors_when_temperature_sensors_dont_exist(
    admin_all_access_token_data: AccessTokenData,
    hvac_zone_temperature_sensors_service_mock: Mock,
    hvac_zone: HvacZone,
    hvac_zones_service_mock: Mock
    ...
    hvac_zone_temperature_sensors_service_mock.get_hvac_zone_temperature_sensors_by_hvac_zone_id.return_value = []
    app.dependency_overrides[get_hvac_zone_temperature_sensors_service] = lambda: hvac_zone_temperature_sensors_service_mock
...
def test_get_hvac_zone_temperature_sensor_when_hvac_zone_is_unauthorized(
    ...
    hvac_zone_temperature_sensor.hvac_zone_id = uuid4()
    hvac_zone_temperature_sensors_service_mock.get_hvac_zone_temperature_sensors_by_hvac_zone_id.return_value = [hvac_zone_temperature_sensor,]
    app.dependency_overrides[get_hvac_zone_temperature_sensors_service] = lambda: hvac_zone_temperature_sensors_service_mock
