...
def test_get_hvac_zone_equipment_is_unauthorized_without_token():
    ...
    response = test_client.get(f'/v1/hvac-zone-equipment?hvac_zone_id={uuid4()}')
...
def test_get_hvac_zone_equipment_access_scopes(
    ...
    response = test_client.get(f'/v1/hvac-zone-equipment?hvac_zone_id={hvac_zone.hvac_zone_id}')
...
def test_get_hvac_zone_equipment_when_equipment_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    hvac_zone_equipment_service_mock: Mock,
    hvac_zones_service_mock: Mock,
    hvac_zone: HvacZone
    ...
    hvac_zone_equipment_service_mock.get_hvac_zone_equipment_by_hvac_zone_id.return_value = []
    app.dependency_overrides[get_hvac_zone_equipment_service] = lambda: hvac_zone_equipment_service_mock
...
def test_get_hvac_zone_equipment_when_hvac_zone_is_unauthorized(
    ...
    hvac_zone_equipment.hvac_zone_id = uuid4()
    hvac_zone_equipment_service_mock.get_hvac_zone_equipment_by_hvac_zone_id.return_value = [hvac_zone_equipment,]
    app.dependency_overrides[get_hvac_zone_equipment_service] = lambda: hvac_zone_equipment_service_mock
