...
def test_delete_temperature_sensor_place_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.delete(f'/v1/temperature-sensor-places/{uuid4()}')
...
def test_delete_temperature_sensor_place_access_scopes(
    ...
    response = test_client.delete(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_place_id}')

    assert response.status_code == response_code


def test_delete_temperature_sensor_place_success_response(
...
def test_delete_temperature_sensor_place_when_temperature_sensor_places_dont_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
):
    app.dependency_overrides[get_access_token_data] = lambda: admin_all_access_token_data
...
def test_delete_temperature_sensor_place_when_location_is_unauthorized(
