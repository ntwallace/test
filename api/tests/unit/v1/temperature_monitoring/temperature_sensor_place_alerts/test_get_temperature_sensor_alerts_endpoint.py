...
def test_get_temperature_sensor_place_alerts_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.get(f'/v1/temperature-sensor-places/{uuid4()}/alerts')
...
def test_get_temperature_sensor_place_alerts_access_scopes(
    ...
    response = test_client.get(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_place_id}/alerts')
    assert response.status_code == response_code


def test_get_temperature_sensor_place_alerts_success_response(
...
def test_get_temperature_sensor_place_alerts_when_no_alerts_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_sensor_place_alerts_service_mock: Mock,
    temperature_sensor_place: TemperatureSensorPlace
    ...
    temperature_sensor_place_alerts_service_mock.get_temperature_sensor_place_alerts_for_temperature_sensor_place.return_value = []
    app.dependency_overrides[get_temperature_sensor_place_alerts_service] = lambda: temperature_sensor_place_alerts_service_mock
...
def test_get_temperature_sensor_place_alerts_when_temperature_sensor_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock
):
    app.dependency_overrides[get_access_token_data] = lambda: admin_all_access_token_data
...
def test_get_temperature_sensor_place_alerts_when_temperature_sensor_is_unauthorized(
