...
from app.v1.dependencies import get_temperature_sensor_places_service, get_temperature_ranges_service, get_access_token_data
...
def test_create_temperature_range_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.post(f'/v1/temperature-sensor-places/{uuid4()}/temperature-ranges')
...
def test_create_temperature_range_access_scopes(
    ...
    response = test_client.post(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_place_id}/temperature-ranges', json={
...
def test_create_temperature_range_success_response(
...
def test_create_temperature_range_when_temperature_range_exists(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_ranges_service_mock: Mock,
    temperature_sensor_place: TemperatureSensorPlace,
    ...
    temperature_ranges_service_mock.create_temperature_range.side_effect = IntegrityError(None, None, None)
    app.dependency_overrides[get_temperature_ranges_service] = lambda: temperature_ranges_service_mock
...
def test_create_temperature_range_when_temperature_sensor_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_ranges_service_mock: Mock,
    temperature_range: TemperatureRange
    ...
    temperature_ranges_service_mock.create_temperature_range.return_value = None
    app.dependency_overrides[get_temperature_ranges_service] = lambda: temperature_ranges_service_mock

    response = test_client.post(f'/v1/temperature-sensor-places/{uuid4()}/temperature-ranges', json={
        'high_degrees_celcius': temperature_range.high_degrees_celcius,
        'low_degrees_celcius': temperature_range.low_degrees_celcius,
        'warning_level': temperature_range.warning_level,
        'temperature_sensor_place_id': str(temperature_range.temperature_sensor_place_id)
...
def test_create_temperature_range_when_temperature_sensor_is_unauthorized(
    ...
    response = test_client.post(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_id}/temperature-ranges', json={
        'high_degrees_celcius': temperature_range.high_degrees_celcius,
        'low_degrees_celcius': temperature_range.low_degrees_celcius,
        'warning_level': temperature_range.warning_level,
        'temperature_sensor_place_id': str(temperature_range.temperature_sensor_place_id)
...
def test_create_temperature_range_when_temperature_sensor_id_is_mismatched(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_ranges_service_mock: Mock,
    temperature_sensor_place: TemperatureSensorPlace,
