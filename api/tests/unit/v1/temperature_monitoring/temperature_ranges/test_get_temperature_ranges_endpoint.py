...
def test_get_temperature_ranges_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.get(f'/v1/temperature-sensor-places/{uuid4()}/temperature-ranges')
...
def test_get_temperature_ranges_access_scopes(
    ...
    response = test_client.get(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_place_id}/temperature-ranges')

    assert response.status_code == response_code


def test_get_temperature_ranges_success_response(
...
def test_get_temperature_ranges_when_temperature_ranges_dont_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_ranges_service_mock: Mock,
    temperature_sensor_place: TemperatureSensorPlace,
    ...
    temperature_ranges_service_mock.get_temperature_ranges_by_temperature_sensor_place_id.return_value = []
    app.dependency_overrides[get_temperature_ranges_service] = lambda: temperature_ranges_service_mock
...
def test_get_temperature_ranges_when_temperature_sensor_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_ranges_service_mock: Mock,
    temperature_range: TemperatureRange
...
def test_get_temperature_ranges_when_temperature_sensor_is_unauthorized(
