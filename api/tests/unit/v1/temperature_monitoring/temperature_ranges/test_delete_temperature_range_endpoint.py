...
def test_delete_temperature_range_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.delete(f'/v1/temperature-sensor-places/{uuid4()}/temperature-ranges/{uuid4()}')
...
def test_delete_temperature_range_access_scopes(
    ...
    response = test_client.delete(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_place_id}/temperature-ranges/{temperature_range.temperature_range_id}')

    assert response.status_code == response_code


def test_delete_temperature_range_success_response(
    ...
    response = test_client.delete(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_id}/temperature-ranges/{temperature_range.temperature_range_id}')

    assert response.status_code == status.HTTP_204_NO_CONTENT


def test_delete_temperature_range_when_temperature_range_dont_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_ranges_service_mock: Mock,
    temperature_sensor_place: TemperatureSensorPlace,
    ...
    response = test_client.delete(f'/v1/temperature-sensor-places/{temperature_sensor_place.temperature_sensor_place_id}/temperature-ranges/{uuid4()}')

    assert response.status_code == status.HTTP_404_NOT_FOUND


def test_delete_temperature_range_when_temperature_sensor_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    temperature_sensor_places_service_mock: Mock,
    temperature_ranges_service_mock: Mock,
    temperature_range: TemperatureRange
    ...
    response = test_client.delete(f'/v1/temperature-sensor-places/{uuid4()}/temperature-ranges/{temperature_range.temperature_range_id}')

    assert response.status_code == status.HTTP_404_NOT_FOUND


def test_delete_temperature_range_when_temperature_sensor_is_unauthorized(
