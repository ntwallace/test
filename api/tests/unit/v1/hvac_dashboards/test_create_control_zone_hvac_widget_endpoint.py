...
def test_create_control_zone_hvac_widget_is_unauthorized_without_token():
    response = test_client.post('/v1/control-zone-hvac-widgets')
...
def test_create_control_zone_hvac_widget_access_scope_responses(
    ...
    response = test_client.post(
        '/v1/control-zone-hvac-widgets',
        json={
            'name': 'Test Control Zone Hvac Widget',
            'hvac_zone_id': str(uuid4()),
            'hvac_dashboard_id': str(uuid4())
        }
    )
...
def test_create_control_zone_hvac_widget_success_response(
...
def test_create_control_zone_hvac_widget_when_location_doesnt_exist_for_jwt_auth(
    admin_all_access_token_data: AccessTokenData,
    control_zone_hvac_widget: ControlZoneHvacWidget,
    hvac_zones_service_mock: Mock,
    locations_service_mock: Mock,
...
def test_create_control_zone_hvac_widget_when_location_doesnt_exist_for_api_key_auth(
    api_key: APIKey,
    control_zone_hvac_widget: ControlZoneHvacWidget,
    hvac_zones_service_mock: Mock,
    locations_service_mock: Mock,
...
def test_create_control_zone_hvac_widget_when_location_is_unauthorized(
    admin_all_access_token_data: AccessTokenData,
    control_zone_hvac_widget: ControlZoneHvacWidget,
    hvac_zones_service_mock: Mock,
    locations_service_mock: Mock,
