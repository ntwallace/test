...
def test_update_user_access_scopes_unauthorized(sample_user_id: UUID):
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.put(
        f'/v1/auth/users/{sample_user_id}/access-scopes',
        json=[AccessScope.ADMIN]
    )
...
def test_update_user_access_scopes_access_scope_responses(
    ...
    mock_user_access_scopes_service.update_user_access_scopes.return_value = new_scopes
...
def test_update_user_access_scopes_success(
    mock_users_service: Mock,
    mock_user_access_scopes_service: Mock,
    ...
    mock_users_service.get_user_by_user_id.return_value = sample_user
    new_scopes = [AccessScope.ADMIN, AccessScope.USERS_READ]
    mock_user_access_scopes_service.update_user_access_scopes.return_value = new_scopes
    ...
    mock_user_access_scopes_service.update_user_access_scopes.assert_called_once_with(sample_user_id, new_scopes)


def test_update_user_access_scopes_user_not_found(
    mock_users_service: Mock,
    mock_user_access_scopes_service: Mock,
    admin_all_access_token_data,
    sample_user_id: UUID
