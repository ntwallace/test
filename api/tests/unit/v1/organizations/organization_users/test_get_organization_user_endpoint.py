...
def test_get_organization_user_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.get(f'/v1/organizations/{uuid4()}/users/{uuid4()}')
...
def test_get_organization_user_access_scope_responses(
    ...
    response = test_client.get(f'/v1/organizations/{organization_user.organization_id}/users/{organization_user.user_id}')

    assert response.status_code == response_code


def test_get_organization_user_success_response(
...
def test_get_organization_user_when_organization_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    organizations_service_mock: Mock,
):
    app.dependency_overrides[get_access_token_data] = lambda: admin_all_access_token_data
...
def test_get_organization_user_when_organization_user_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    organizations_service_mock: Mock,
    organization_users_service_mock: Mock,
    organization: Organization,
    ...
    response = test_client.get(f'/v1/organizations/{organization.organization_id}/users/{uuid4()}')
