...
def test_delete_electric_sensor_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.delete(f'/v1/electric-sensors/{uuid4()}')
...
def test_delete_electricity_sensor_access_scope_responses(
    ...
    response = test_client.delete(f'/v1/electric-sensors/{electric_sensor.electric_sensor_id}')
    
    assert response.status_code == response_code


def test_delete_electric_sensor_success_response(
...
def test_delete_electric_sensor_without_panel_success_response(
    admin_all_access_token_data: AccessTokenData,
    electric_sensors_service_mock: Mock,
    gateways_service_mock: Mock,
    gateway: Gateway,
...
def test_delete_electric_sensor_when_electric_sensor_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    electric_sensors_service_mock: Mock
):
    app.dependency_overrides[get_access_token_data] = lambda: admin_all_access_token_data
...
def test_delete_electric_sensor_when_electric_panel_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    electric_sensors_service_mock: Mock,
    electric_panels_service_mock: Mock,
    gateways_service_mock: Mock,
    ...
    electric_sensor.electric_panel_id = uuid4()
    electric_sensors_service_mock.get_electric_sensor_by_id.return_value = electric_sensor
    app.dependency_overrides[get_electric_sensors_service] = lambda: electric_sensors_service_mock
...
def test_delete_electric_sensor_when_gateway_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    electric_sensors_service_mock: Mock,
    gateways_service_mock: Mock,
    electric_sensor: ElectricSensor
