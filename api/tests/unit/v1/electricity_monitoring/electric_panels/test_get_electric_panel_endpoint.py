...
def test_get_electric_panel_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.get(f'/v1/electric-panels/{uuid4()}')
...
def test_get_electric_panel_access_scope_responses(
    ...
    response = test_client.get(f'/v1/electric-panels/{electric_panel.electric_panel_id}')
    
    assert response.status_code == response_code


def test_get_electric_panel_success_response(
...
def test_get_electric_panel_when_electric_panel_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    electric_panels_service_mock: Mock,
):
    app.dependency_overrides[get_access_token_data] = lambda: admin_all_access_token_data
...
def test_get_electric_panel_when_location_is_unauthorized(
