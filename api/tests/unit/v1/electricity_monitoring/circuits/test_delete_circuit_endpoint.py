...
def test_delete_circuit_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.delete(f'/v1/circuits/{uuid4()}')
...
def test_delete_circuit_access_scope_responses(
    ...
    response = test_client.delete(f'/v1/circuits/{circuit.circuit_id}')
    
    assert response.status_code == response_code


def test_delete_circuit_success_response(
...
def test_delete_circuit_response_when_circuit_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    circuits_service_mock: Mock,
    electric_panels_service_mock: Mock,
    electric_panel: ElectricPanel,
...
def test_delete_circuit_when_electric_panel_doesnt_exist(
    admin_all_access_token_data: AccessTokenData,
    circuits_service_mock: Mock,
    electric_panels_service_mock: Mock,
    circuit: Circuit
...
def test_delete_circuit_when_location_is_unauthorized(
