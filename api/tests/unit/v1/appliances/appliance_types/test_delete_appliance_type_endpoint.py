...
def test_delete_appliance_type_is_unauthorized_without_token():
    app.dependency_overrides[get_access_token_data] = get_access_token_data
    response = test_client.delete(f'/v1/appliance-types/{uuid4()}')
...
def test_delete_appliance_type_access_scope_responses(
    ...
    response = test_client.delete(f'/v1/appliance-types/{appliance_type.appliance_type_id}')

    assert response.status_code == response_code


def test_delete_appliance_type_success_response(
